...
// one's configured (config.gameRoleIds), and (2) always post a heads-up
// embed (with a Join Channel button) in the fixed game-announcements
// channel (config.gameAnnounceChannelId) so people watching that channel
// can jump straight into the new game channel. Both are safe no-ops until
// configured.
//
